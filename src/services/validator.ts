...
export class OrderValidator {
  static requiredFields: (keyof SourceOrderData)[] = ['orderId', 'orderDate', 'customerId', 'storeId', 'items', 'paymentMethod', 'totalAmount', 'status'];

  static validate(data: SourceOrderData): string[] | null {
    const errors: string[] = [];
